...
public class SwerveSubsystem extends SubsystemBase {
	...
	public SwerveSubsystem(File directory) {
		...
		swerveDrive.setAngularVelocityCompensation(
				true, true,
				0.1); // Correct for skew that gets worse as angular velocity increases. Start with
	...
	public void periodic() {
		...
		SmartDashboard.putNumber(
				...
				swerveDrive.getModulePositions()[1].angle.getRotations());
		SmartDashboard.putNumber(
				"Back right azimuth rotations",
				swerveDrive.getModulePositions()[3].angle.getRotations());
		SmartDashboard.putNumber(
				"Back left azimuth rotations",
				swerveDrive.getModulePositions()[2].angle.getRotations());
		SmartDashboard.putNumber(
				"Front left azimuth rotations",
				swerveDrive.getModulePositions()[0].angle.getRotations());
		SmartDashboard.putNumber(
				"Top right drive meters", swerveDrive.getModulePositions()[1].distanceMeters);
		SmartDashboard.putNumber(
				"Back right drive meters", swerveDrive.getModulePositions()[3].distanceMeters);
		SmartDashboard.putNumber(
				"Back left drive meters", swerveDrive.getModulePositions()[2].distanceMeters);
		SmartDashboard.putNumber(
				"Front left drive meters", swerveDrive.getModulePositions()[0].distanceMeters);
	}
